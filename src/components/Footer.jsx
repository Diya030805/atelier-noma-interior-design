...
export default function Footer({ onNavigate }) {
  ...
  return (
    <footer className="bg-soft-charcoal text-warm-ivory/80 pt-16 pb-12 relative overflow-hidden border-t border-deep-espresso/15">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 pb-16 border-b border-warm-ivory/10">
          ...
          <div className="md:col-span-5 flex flex-col items-start text-left gap-4">
            <a href="#hero" onClick={handleScrollToTop} className="flex flex-col items-start focus-ring">
              <span className="font-serif text-2xl font-semibold tracking-[0.25em] text-white">
                ATELIER NOMA
              </span>
          ...
          <div className="md:col-span-3 text-left">
            <h4 className="font-sans text-xs font-bold tracking-widest text-white uppercase mb-6">
              NAVIGATION
            </h4>
          ...
          <div className="md:col-span-4 text-left">
            ...
            <div className="space-y-4 font-sans text-xs leading-relaxed text-warm-ivory/70">
              <div>
                <p className="font-bold text-white tracking-wider uppercase mb-1">CONTACT EMAIL</p>
              ...
              <div>
                <p className="font-bold text-white tracking-wider uppercase mb-1">MUMBAI HQ</p>
                <p>302, Nariman Point, Marine Drive, Mumbai, 400021</p>
              </div>

              <div>
                <p className="font-bold text-white tracking-wider uppercase mb-1">GOA OFFICE</p>
        ...
        <div className="pt-10 flex flex-col sm:flex-row items-center justify-between gap-6 font-sans text-xs text-warm-ivory/50">
          ...
          <div className="flex items-center gap-6">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="hover:text-white transition-colors focus-ring p-1"
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="hover:text-white transition-colors focus-ring font-sans font-bold text-xs"
          ...
          <div>
            <button
              ...
              className="inline-flex items-center gap-2 font-sans text-[10px] font-bold tracking-widest uppercase hover:text-white text-warm-ivory/60 transition-colors focus-ring py-2 cursor-pointer"
            >
